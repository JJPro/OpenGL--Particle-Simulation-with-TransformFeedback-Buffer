...
if platform.system()=="Linux":
    ...
    INCLUDE_DIR = "-I ./include/ -I./include/lib/glm -I./include/lib/"
    LIBRARIES="-lSDL2 -ldl"
elif platform.system()=="Darwin":
    ARGUMENTS="-D MAC" # -D is a #define sent to the preprocessor.
    INCLUDE_DIR = "-I ./include/ -I./include/lib/glm -I./include/lib/ -I/Library/Frameworks/SDL2.framework/Headers"
